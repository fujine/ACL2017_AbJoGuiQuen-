...
public class Chevalier<dep> extends Monstre {
    ...
    public void deplacer() {
        ...
        if (dist > 3) {
            ...
            if(distHaut < dist && plateau.estLibre(posX,posY-vitesse)){
                System.out.println("haut");
                posY-=vitesse;
                dir = Direction.HAUT;
            }else if(distBas < dist && plateau.estLibre(posX,posY+vitesse) ){
                System.out.println("bas");
                posY+=vitesse;
                dir = Direction.BAS;

            }else if(distDroite < dist && plateau.estLibre(posX+vitesse,posY)){
                System.out.println("droite");
                posX+=vitesse;
                dir = Direction.DROITE;

            }else if(distGauche < dist && plateau.estLibre(posX-vitesse,posY)){
